        ...
        <div className={[classes.SportEvents, classes[theme.palette.mode]].join(' ')}>
            <GlassyBox className={classes.GlassyBox}>
                ...
                <div className={classes.EventsWrapper}>
                    ...
                    {sportEvents.football.length ? sportEvents.football.map(event => <div key={Math.random()}
                ...
                <div className={classes.SavedEvents}>
                    ...
                    {favoriteSportEvents?.length ? favoriteSportEvents.map(event => <div key={event.id}>
